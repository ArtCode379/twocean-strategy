package twocean.management.twoceanstrategy.ui.composable.approot
...
import twocean.management.twoceanstrategy.ui.composable.navigation.AppNavHost
import twocean.management.twoceanstrategy.ui.composable.navigation.NavRoute
import kotlin.reflect.KClass

private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.hrpik_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home
    ),
    BottomNavItem(
        titleRes = R.string.hrpik_bottom_bar_nav_item_bookings_title,
        icon = Icons.Default.Book,
        route = NavRoute.Bookings
    ),
    BottomNavItem(
        titleRes = R.string.hrpik_bottom_bar_nav_item_settings_title,
