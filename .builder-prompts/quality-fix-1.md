Fix the Android project at /tmp/twocean-strategy so the failing quality-fix-1 step passes.
...
Recent failure log:
```text
=== QUALITY CHECK: /tmp/twocean-strategy ===
...
0: integer expression expected
  OK: Repository: 0
0 entries
  PLACEHOLDER-LIKE: app/src/main/res/drawable/service_6.jpg (colors=49707, entropy=0.676404)
  OK: 9 images
  OK: All images valid
FAIL: 1 placeholder-like drawable image(s); use real photos or filesystem-backed imagegen output, not local generated placeholders
  ...
  OK: icon.png (207394B, 512x512, rounded opaque canvas, transparent corners)
